			...
			<div class="navbar navbar-expand-lg navbar-light">
				...
				<div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2021. <a href="#">YEMRESOFT</a> by <a href="http://yemresoft.com" target="_blank">Yunus Koocabay</a>
					</span>

					<ul class="navbar-nav ml-lg-auto">
						<li class="nav-item"><a href="http://yemresoft.com/" class="navbar-nav-link" target="_blank"><i class="icon-lifebuoy mr-2"></i> Destek</a></li>
						<li class="nav-item"><a href="http://yemresoft.com/" class="navbar-nav-link" target="_blank"><i class="icon-file-text2 mr-2"></i> Dökümantasyon</a></li>
						<li class="nav-item"><a href="http://yemresoft.com/" class="navbar-nav-link font-weight-semibold"><span class="text-pink-400"><i class="icon-cart2 mr-2"></i> Purchase</span></a></li>
					</ul>
				</div>
			</div>
			<!-- /footer -->
