<form id="EditParamForm">
    <!-- Basic modal -->
    <div id="EditParamModal" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Parametre Düzenle: <span class="text-danger">{{ $param->alan }}</span></h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn bg-primary EditParamSubmit">Kaydet</button>
                </div>
            </div>
        </div>
    </div>
...
{!! JsValidator::formRequest('App\Http\Requests\Params\StoreParamRequest', '#EditParamForm'); !!}

<script type="text/javascript">
$(document).on('click', '.EditParamSubmit', function(e){
e.preventDefault();

    if($("#EditParamForm").valid())
      {
          var data = $("#EditParamForm").serialize();
